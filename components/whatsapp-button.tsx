  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs mt-1">Chat with us on WhatsApp for instant support!</p>
          </div>
        </div>
      ...
      <a
        ...
        className="group relative w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg shadow-[#25D366]/30 hover:shadow-xl hover:shadow-[#25D366]/40 hover:scale-110 transition-all duration-300"
      >
        {/* Pulse rings */}
